...
async def vapor(vpr):
    ...
    if message:
        ...
        return await vpr.edit(
            "`B e r i k a n S e b u a h T e k s U n t u k Vａｐｏｒ！`"
        )
...
async def zal(zgfy):
    ...
    if message:
        ...
        return await zgfy.edit("`b̜́ͨe͒͜r̠͂ͬi̷̱̋k͖͒ͤa̋ͫ͑n͕͂͗ t̢͘͟e͂̽̈́k͎͂͠s̤͚ͭ m̪͔͑è͜͡n͈ͮḁ͞ͅk̲̮͛u̺͂ͩt̬̗́k͍̙̮á ̺n̨̹ͪ`")
...
async def claptext(memereview):
    ...
    if message:
        ...
        return await memereview.edit(
            "`Mohon Balas Ke Pesan Orang Yang Ingin Anda Puji`"
        )
    reply_text = "👏 "
