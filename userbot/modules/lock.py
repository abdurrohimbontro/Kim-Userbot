...
async def locks(event):
    ...
    if input_str == "msg":
        ...
        if not input_str:
            ...
            await event.edit(
                f"`King Jenis Yang Mau Anda Kunci Tidak Valid` `{input_str}`"
            )
            return
    ...
    try:
        ...
        await event.edit(f"`King Telah Mengunci {what} Untuk Obrolan Ini`")
    except BaseException as e:
        await event.edit(
            f"`Apakah King Mempunyai Izin Melakukan Itu Disini?`\n**Kesalahan:** {str(e)}"
        )
        return
...
async def rem_locks(event):
    ...
    if input_str == "msg":
        ...
        if not input_str:
            ...
            await event.edit(
                f"`Tuan Jenis Kunci Yang Mau Anda Buka Tidak Valid` `{input_str}`"
            )
            return
    ...
    try:
        ...
        await event.edit(f"`King Telah Membuka Kunci {what} Untuk Obrolan Ini`")
    except BaseException as e:
        await event.edit(
            f"`Apakah King Mempunyai Izin Melakukan Itu Disini?`\n**Kesalahan:** {str(e)}"
        )
