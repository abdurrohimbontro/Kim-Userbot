...
async def who(event):
    ...
    await event.edit("`Mencari Informasi Pengguna...🔍`")
...
async def fetch_info(replied_user, event):
    ...
    caption += f"ID pengguna: <code>{user_id}</code>\n\n"
    caption += f"Bio pengguna: \n<code>{user_bio}</code>\n\n"
    caption += f"Obrolan umum pengguna: {common_chat}\n"
    caption += f"Link profile pengguna: "
