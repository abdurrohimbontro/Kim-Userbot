...
USERNAME_TAKEN = (
    "```Mohon Maaf Tuan Muda, Username Itu Sudah Ada Yang Menggunakannya.```"
)
# ===============================================================
...
CMD_HELP.update(
    {
        "profil": "⚡𝘾𝙈𝘿⚡`.username` <username baru>\
\nUsage: Ganti Username Telegram.\
\n\n⚡𝘾𝙈𝘿⚡`.name` <nama depan> Atau `.name` <Nama Depan> <Nama Belakang>\
...
\n\n⚡𝘾𝙈𝘿⚡`.delpfp` Atau `.delpfp` <berapa profil>/<all>\
...
\n\n⚡𝘾𝙈𝘿⚡`.data` <username> Atau Balas Ke Pesan Ketik `.data`\
